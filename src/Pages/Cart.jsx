   ...
   <Header></Header>
      ...
      <div className="col-lg-8">
              ...
              cart?.map((product,index)=>(
                <tr key={index}>
                  ...
                  <td>
                    ...
                    <input style={{width:'50px'}} className="form-control text-center" value={product?.quantity} type="text" readOnly/>
        ...
        <div className="float-end mb-3 mt-3">
          ...
          <Link to={'/'} className="btn btn-success me-3">Shop More</Link>
